...
class MyApp(App):
    ...
    def main(self):  
        ...
        A1 = gui.Container(margin='0px auto', width='100%', height= '100%',  position = 'relative',  background_color = 'red')
        self.plot1 = Plot(self)        
        A1.append(self.plot1)
        # returning the root widget
        return A1

    def on_close(self):
        self.plot1.stop_flag = True
