...
class GUI:
    ...
    def construct_ui(self):
        ...
        self.frame_left = C.create_container(self.window, 70, 20, 0, 10)
        ...
        self.frame_right = C.create_container(self.window, 70, 40, 21, 10)
        self.frame_right.css_background_color = self.frame_right_color
        self.frame_right_2 = C.create_container(self.window, 70, 28, 62, 10)
    ...
    def login_ok_clicked(self):
        ...
        if x.empty or y.empty:
            ...
            # --------------------- BUTTONS --------------------------------------------------------- ]
            self.btn_analyze = C.create_button(self.frame_left, 7, 30, 2, 25, bg='cornflowerblue',
    ...
    def run_analyzer(self):
        self.T = Thread(target=self.run_analysis, daemon=True).start()



    def run_analysis(self):
        try:
            with self.A.update_lock:
            ...
            if self.selected_bank[-1] == 'Axis Bank':
                ...
                with self.A.update_lock:
                    ...
                    self.set_notification('Initializing Neural Network...', bar=2)
                ...
                self.btn_graph = C.create_button(self.frame_left, 7, 40, 45, 25, bg='yellowgreen',
